...
export const ressources: Ressource[] = [
  ...
  },
  {
    ...
    category: "Validation",
    icon: CheckSquare,
    description: "Validation TypeScript-first avec inference de types",
    longDescription:
      "Zod est une bibliothèque de validation TypeScript-first qui permet de définir des schémas de validation et d'inférer automatiquement les types TypeScript. Elle offre une validation runtime type-safe, des messages d'erreur détaillés et une excellente intégration avec React Hook Form et t3-env.",
    website: "https://zod.dev",
    npmPackage: "zod",
    useCases: [
      "Validation de formulaires avec React Hook Form",
      "Validation de réponses API",
      "Validation de variables d'environnement (t3-env)",
      "Parsing et validation de données externes",
    ...
    features: [
      ...
      "Schémas récursifs et conditionnels",
    ],
    color: {
      bg: "bg-green-100",
  ...
  },
  {
    ...
    category: "Development",
    icon: Wrench,
    description: "Toolchain rapide pour formater et linter votre code",
    longDescription:
      "Biome est un toolchain complet pour le web qui combine formatage et linting en un seul outil ultra-rapide. Il offre 97% de compatibilité avec Prettier pour le formatage et 388 règles de linting pour JavaScript, TypeScript, JSX, CSS et GraphQL. Construit en Rust, il est jusqu'à 35x plus rapide que Prettier.",
    website: "https://biomejs.dev",
    npmPackage: "@biomejs/biome",
    useCases: [
      "Formatage de code (remplacement de Prettier)",
      "Linting avec règles ESLint/TypeScript ESLint",
      "Formatage et linting en une seule commande",
      "Intégration CI/CD rapide",
      "Formatage de code malformé",
    ],
    features: [
      "97% de compatibilité avec Prettier",
      "388 règles de linting",
      "Jusqu'à 35x plus rapide que Prettier",
      "Support JavaScript, TypeScript, JSX, JSON, HTML, CSS, GraphQL",
      "Formatage de code malformé",
      "Diagnostics détaillés et contextuels",
  ...
  },
  {
    ...
    category: "Testing",
    icon: Terminal,
    description: "Framework de tests rapide et moderne pour Vite",
    longDescription:
      "Vitest est un framework de tests ultra-rapide construit sur Vite. Il offre une compatibilité complète avec Jest, une exécution parallèle des tests, un hot module replacement pour les tests, et une intégration native avec Vite pour un développement fluide.",
    website: "https://vitest.dev",
    npmPackage: "vitest",
    useCases: [
      "Tests unitaires pour projets Vite",
      "Tests de composants React/Vue",
      "Tests d'intégration rapides",
      "Tests avec TypeScript natif",
      "Tests parallèles",
    ],
    features: [
      "Compatible avec Jest (même API)",
      "Ultra-rapide (basé sur Vite)",
      "HMR pour les tests",
      "TypeScript natif",
      "Coverage intégré",
  ...
  },
  {
    ...
    category: "Testing",
    icon: Terminal,
    description: "Framework de tests JavaScript complet et populaire",
    longDescription:
      "Jest est un framework de tests JavaScript développé par Facebook. Il offre une solution complète pour tester les applications JavaScript avec un focus sur la simplicité et la productivité. Il inclut un runner de tests, des assertions, des mocks, et un système de coverage intégré.",
    ...
    useCases: [
      ...
      "Tests d'intégration",
      "Tests de snapshots",
      "Tests avec mocks et spies",
      "Coverage de code",
      "Tests pour React, Node.js, etc.",
    ],
    features: [
      "Zero configuration (par défaut)",
      "Snapshots pour tester les UI",
      "Mocks et spies intégrés",
  ...
  },
  {
    ...
    category: "Testing",
    icon: CheckSquare,
    description: "Bibliothèques de tests simples et complètes pour tester les composants UI",
    longDescription:
      "Testing Library est une famille de bibliothèques de tests qui encourage les bonnes pratiques de test en se concentrant sur le test des composants comme les utilisateurs les utilisent. Elle offre des utilitaires pour interagir avec les composants de manière accessible et réaliste.",
    ...
    features: [
      "Philosophie orientée utilisateur",
      "Queries accessibles (getByRole, etc.)",
      "Support multi-frameworks (React, Vue, Angular, etc.)",
      "Utilitaires d'interaction réalistes",
  ...
  },
  {
    ...
    category: "Testing",
    icon: Terminal,
    description: "Framework de tests end-to-end moderne pour le web",
    longDescription:
      "Cypress est un framework de tests end-to-end qui permet de tester facilement tout ce qui s'exécute dans un navigateur. Il offre une API simple, un time-travel debugging, des captures d'écran automatiques, et une excellente expérience développeur avec son interface graphique.",
  ...
  },
  {
    ...
    category: "Testing",
    icon: Code2,
    description: "Framework de tests E2E rapide et fiable pour navigateurs modernes",
    longDescription:
      "Playwright est un framework de tests end-to-end développé par Microsoft qui permet de tester des applications web sur tous les navigateurs modernes. Il offre une API puissante, une exécution parallèle, des fonctionnalités avancées comme l'auto-waiting, et une excellente intégration avec les outils CI/CD.",
    ...
    useCases: [
      ...
      "Tests de régression",
      "Tests d'applications web complexes",
      "Tests de performance",
      "Tests d'accessibilité automatisés",
      "Tests de mobile (responsive)",
    ],
    features: [
  ...
  },
  {
    ...
    category: "Monitoring",
    icon: Shield,
    description: "Plateforme d'observabilité et de monitoring pour applications cloud",
    longDescription:
      "Datadog est une plateforme d'observabilité complète qui permet de surveiller les applications, l'infrastructure, les logs, et les métriques en temps réel. Elle offre une vue unifiée sur toute la stack technique avec des dashboards personnalisables, des alertes intelligentes, et une intégration avec plus de 500 technologies.",
    ...
    features: [
      ...
      "Intégration avec 500+ technologies",
  ...
  },
  {
    ...
    category: "Monitoring",
    icon: Bell,
    description: "Plateforme de monitoring d'erreurs et de performance pour applications",
    longDescription:
      "Sentry est une plateforme de monitoring d'erreurs qui permet de détecter, trier et résoudre les problèmes en production en temps réel. Elle offre un tracking d'erreurs exceptionnel, des performances monitoring, et des insights détaillés pour aider les équipes à débugger rapidement les problèmes.",
    ...
    features: [
      ...
      "Session replay",
      "Alertes intelligentes",
      "Intégration avec Slack, GitHub, etc.",
